  ...
  static List<Product> getAllProducts() {
    return [
      ...
      Product(
        ...
        description: 'Comfortable zip hoodie from our Essential Range. Available in multiple colors.',
        price: 20.00,
        salePrice: 14.99,
      ...
      Product(
        ...
        description: 'Classic t-shirt from our Essential Range. Perfect for everyday wear.',
        price: 10.00,
        salePrice: 6.99,
      ...
      Product(
        ...
        description: 'Premium hoodie from our Signature Range. High quality material and design.',
        price: 32.99,
        imageUrl: 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=500',
      ...
      Product(
        ...
        description: 'Beautiful Portsmouth city magnet featuring iconic landmarks.',
        price: 4.50,
  ...
  static List<Collection> getAllCollections() {
    ...
    return [
      Collection(
        ...
        imageUrl: 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=500',
        products: products.where((p) => p.category == 'Essential Range').toList(),
      ),
      Collection(
        id: 'signature-range',
        ...
        imageUrl: 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=500',
        products: products.where((p) => p.category == 'Signature Range').toList(),
      ),
      Collection(
        id: 'portsmouth-city',
        ...
        imageUrl: 'https://images.unsplash.com/photo-1513885535751-8b9238bd345a?w=500',
        products: products.where((p) => p.category == 'Portsmouth City Collection').toList(),
      ),
    ];
  }
